...
int final_total = 0; // this is just the random total addition
pthread_mutex_t Lock = PTHREAD_MUTEX_INITIALIZER;
int total_work = 0; // to keep track of work done
...
int main(int argc, char *argv[])
{
    ...
    // create array of threads and arguments
